...
int main()
{
	string file_in{ "G:/private/03-code/dictionary.txt" };
	...
	std::copy(std::istreambuf_iterator<char>{in}, std::istreambuf_iterator<char>{}, std::ostream_iterator<char>{std::cout, " "});
